var MapController = function($scope, $document){
    ...
    var width = $document.find('#container').clientWidth;
    var height = width / 2;
...
var MapController1 = function($scope, $location){

};

var MapController2 = function($scope, $location) {
...
//app.controller("MapController", MapController1);
//app.controller("MapController", MapController2);